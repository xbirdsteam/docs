...
- TestGenAI will analyze your input and automatically generate structured **checklist**, covering all main scenarios and edge cases. Then you can expand it to **Test cases** by clicking the **Generate All TCs** button
...
<CardGroup cols={2}>
  ...
  <Card title="Rebuild Checklist" icon="repeat" href="/using-testgenai/RebuildChecklist">
    Creates a  new checklist based on original requirements, ignoring current checklist
  </Card>
  <Card title="Clone Checklist" icon="copy" href="/using-testgenai/CloneChecklist">
    Remove all test cases, keep the checklists, and create a new version
  </Card>
  <Card title="Translate" icon="language" href="/using-testgenai/Translate">
    Creates a new checklist version with all items translated to selected language
  </Card>
</CardGroup>

...
<CardGroup cols={1}>
  <Card title="Create Test cases" icon="wand-magic-sparkles" href="/using-testgenai/CreatingTestCases">
...
<CardGroup cols={2}>
  ...
  <Card title="Clone Scenarios" icon="copy" href="/using-testgenai/CloneScenarios">
  ...
  <Card title="Translate" icon="language" href="/using-testgenai/Translate">
    Creates a new test scenarios version with all items translated to selected language
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  ...
  <Card title="Buying More Points" icon="square-plus" href="/plan-and-pointsbuying-more-points">

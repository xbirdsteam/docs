...
- **Unused Points Handling:**
  - If you are upgrading from the **STARTER** plan, unused points are **not** deducted from the new plan price.
  - If you are upgrading from the **PREMIUM** plan, the value of your unused points will be **deducted** from the price of the new plan.
- **How Unused Points Value Is Calculated:**
  1. **Value per point** = Amount paid ÷ (Total monthly points × Number of months)
  2. **Value of unused points** = Number of unused points × Value per point

  **Example:**\
  If you purchased a 12-month PREMIUM plan for 4,990,000₫:
  - Value per point = 4,990,000 ÷ (1,000,000 × 12) = 0.416₫
  - If you have 500,000 unused points, value = 500,000 × 0.416 = 208,000₫
...
- Users on **STARTER, PREMIUM, and MAX** plans can buy extra points after using up their monthly allocation.
- Additional points are valid **only for the current monthly cycle** and will expire at the end of that period.

  <Card title="Purchasing additional points" icon="square-plus" href="/plan-and-points/buying-more-points">
    Purchase more points when your plan runs out of points in current month.
  </Card>

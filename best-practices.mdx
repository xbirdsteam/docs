...
<CardGroup cols={2}>
  ...
  <Card title="Tạo Checklist" icon="wand-magic-sparkles" href="/using-testgenai/create-testcases#3-input-feature-requirements">
    Nhập thông tin về tính năng và yêu cầu AI tạo Checklist
  </Card>
</CardGroup>
...
<CardGroup cols={2}>
  <Card title="Review và điều chỉnh Checklist" icon="file-pen" href="/using-testgenai/update-with-changes">
    Cách review và comment \+ yêu cầu AI cập nhật lại checklist
  </Card>
  <Card title="Điều chỉnh tay Checklist" icon="marker">

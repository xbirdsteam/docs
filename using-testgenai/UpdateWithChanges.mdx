...
- When ready, click **Update with changes**:\
  AI will process your feedback and update the Test Scenarios accordingly.
...
<Card title="Generate Test Cases" icon="wand-magic-sparkles" href="/using-testgenai/CreatingTestCases">

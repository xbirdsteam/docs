...
- **Only the selected test case is changed**; this action does **not** create a new version of the overall checklist or test cases.
...
<Tip>
  ...
  - Use this feature to update an individual test case at any time
  - Be specific in your request to ensure the updated test case meets your expectations.
  - For batch updates or changes to the checklist structure, use "Update with changes" at the checklist level.
</Tip>
